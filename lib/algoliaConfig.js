...
export const CART_UPDATE_EVT = "CART_UPDATE_EVT";
 ...
 * @returns
 */
async function clientProxy(clientBase) {
  return {
    search(requests) {
...
/**
 * Custom Router implementation In case you want to handle routes differently.
 * This implementation uses Single Index (https://www.algolia.com/doc/api-reference/widgets/single-index-state-mapping/js/)
